...
const blogPosts = [
  {
    ...
    date: "Nov 15, 2024",
    category: "Tutorial",
    excerpt: "Learn the basics of conductive tape, LEDs, and circuit design in this beginner-friendly guide.",
    readTime: "5 min read",
  ...
  },
  {
    ...
    date: "Nov 12, 2024",
    category: "Projects",
    excerpt: "Discover hands-on projects that will teach you programming and mechanical engineering.",
    readTime: "8 min read",
  ...
  },
  {
    ...
    date: "Nov 10, 2024",
    category: "Guide",
    excerpt: "Everything you need to know about securing your IoT projects and protecting user data.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    date: "Nov 8, 2024",
    category: "Tutorial",
    excerpt: "Step-by-step instructions to build and program your first autonomous drone.",
    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="relative z-10 pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h1 className="font-display font-bold mb-6" style={{fontSize: 'clamp(2.5rem, 5vw, 3.75rem)'}}>
              <span style={{ background: "linear-gradient(90deg, rgb(168, 85, 247), rgb(34, 211, 238))", backgroundClip: "text", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                STEM Insights
              </span>
            </h1>
