...
import { ArrowLeft, CheckCircle, Clock, Users, Zap, Bot, Wifi, Network, Plane } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="font-mono text-sm text-muted-foreground uppercase tracking-wider mb-1" data-testid={`text-course-code-${course.id}`}>
                  {course.code}
                </p>
                <h1 className="font-display font-bold text-foreground" style={{fontSize: 'clamp(2.5rem, 5vw, 3.75rem)'}} data-testid={`text-course-name-${course.id}`}>
                  {course.name}
                </h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 border-2 border-border bg-card/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  {Icon && <Icon className="w-6 h-6" style={{ color: course.neonColor }} />}
                </div>
                <div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Join hundreds of students already learning with BlackMonkey. Enroll now and start building your future.
                </p>
                <Button
                  size="lg"
