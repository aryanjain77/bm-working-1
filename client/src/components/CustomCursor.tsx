...
export function CustomCursor() {
  ...
  return (
    <>
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 border-2 border-neon-purple rounded-full pointer-events-none z-[9999] mix-blend-difference hidden md:block"
        variants={variants}
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-1 h-1 bg-neon-cyan rounded-full pointer-events-none z-[9999] mix-blend-difference hidden md:block"
        style={{
          left: dotX,
          top: dotY,
        }}
