...
export function Testimonials() {
  return (
    <section className="relative py-32 overflow-hidden">
      <div className="absolute bottom-0 right-0 text-[8rem] font-display font-bold text-foreground/[0.02] select-none pointer-events-none">
        VOICES
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-display font-bold mb-6" style={{fontSize: 'clamp(2.5rem, 5vw, 3.75rem)'}} data-testid="text-testimonials-title">
            ...
            <span className="text-foreground"> From Real Families</span>
          </h2>
