...
export function CoursesSection({ onCourseSelect }: CoursesSectionProps) {
  ...
  return (
    <section id="courses" className="relative py-32 overflow-hidden">
      <div className="absolute top-0 left-0 text-[4rem] sm:text-[6rem] md:text-[8rem] font-display font-bold text-foreground/[0.02] select-none pointer-events-none overflow-hidden">
        COURSES
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-display font-bold mb-6" style={{fontSize: 'clamp(2.5rem, 5vw, 3.75rem)'}} data-testid="text-courses-title">
            ...
            <span className="text-foreground"> to Mastery</span>
          </h2>
          <p className="font-tech text-xl text-muted-foreground max-w-3xl mx-auto whitespace-nowrap" data-testid="text-courses-subtitle">
