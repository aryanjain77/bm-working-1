...
export function WhyChooseUs() {
  ...
  return (
    <section id="whyus" className="relative py-32 overflow-hidden">
      <div className="absolute top-0 right-0 text-[8rem] font-display font-bold text-foreground/[0.03] select-none pointer-events-none">
        WHY US
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="text-why-us-subtitle">
            We're not your typical STEM program. We're unhinged, innovative, and obsessed with results.
          </p>
        </motion.div>
