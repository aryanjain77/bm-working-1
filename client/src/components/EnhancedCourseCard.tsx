      ...
      >
        ...
        >
          ...
          <div className="relative p-8 flex-1 flex flex-col">
            ...
            {/* Tagline */}
            <motion.p
              className="text-lg font-semibold leading-relaxed mb-6 flex-1"
            ...
            {/* CTA */}
            <motion.div
              className="flex items-center text-muted-foreground group-hover:text-foreground transition-colors cursor-pointer"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
