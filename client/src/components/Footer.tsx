    ...
    <footer className="relative bg-card/30 border-t border-border backdrop-blur-sm overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>hello@blackmonkey.edu</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-6">Courses</h4>
            <ul className="space-y-3">
              {footerLinks.courses.map((link) => (
                <li key={link.path}>
                  <Link href={link.path}>
                    <button className="text-sm text-muted-foreground hover:text-neon-purple transition-colors text-left bg-transparent border-0 font-sans p-0" data-testid={`link-footer-${link.label.toLowerCase().replace(/\s+/g, '-')}`}>
                      {link.label}
                    </button>
                  </Link>
                </li>
...
>
  <ArrowUp className="h-5 w-5" />
            ...
            <div className="flex gap-2 mb-6">
              ...
              />
              <Button variant="default" className="bg-gradient-to-r from-neon-purple to-neon-pink" data-testid="button-newsletter-subscribe">
                Join
              </Button>
            </div>
