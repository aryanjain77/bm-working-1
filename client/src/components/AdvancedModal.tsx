          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="relative p-8 md:p-12 space-y-6">
                ...
                >
                  <h2 className="text-4xl md:text-5xl font-display font-bold" style={{fontSize: 'clamp(2rem, 4vw, 3rem)'}}>
                    <span style={{ color: course.neonColor }}>{course.name}</span>
                  </h2>
                  <p className="text-lg mt-2" style={{ color: course.neonColor, opacity: 0.8 }}>
                    {course.tagline}
                  </p>
                </motion.div>
                ...
                >
                  <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/30">
                    ...
                    <p className="font-bold" style={{ color: course.neonColor }}>
                      {course.ageGroup}
                    </p>
                  </div>
                  <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/30">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {course.features.map((feature, idx) => (
                      <motion.div
                        ...
                        className="flex items-start gap-2 p-2 rounded-lg hover:bg-slate-700/30 transition-colors"
                      >
                        <span
