...
export const coursesData: Course[] = [
  ...
  },
  {
    ...
    code: "CHAKRA_02",
    name: "Chakra",
    tagline: "Command robots with code and imagination",
...
export const statsData: Stat[] = [
  { label: "Students Transformed", value: 5000, suffix: "+", icon: "Users" },
  { label: "Projects Built", value: 15000, suffix: "+", icon: "Rocket" },
  { label: "Success Rate", value: 98, suffix: "%", icon: "TrendingUp" },
  { label: "Parent Satisfaction", value: 99, suffix: "%", icon: "Heart" }
];
